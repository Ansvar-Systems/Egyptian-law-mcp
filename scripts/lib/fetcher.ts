/**
 * Rate-limited HTTP client for Egyptian legislation from the Sejm ELI API.
 *
...
const USER_AGENT = 'Egyptian-Law-MCP/1.0 (https://github.com/Ansvar-Systems/egyptian-law-mcp; hello@ansvar.ai)';
